<x-app-layout> {{-- pour extend du fichier blade "app" dans les layouts --}}
    {{-- Dans le app.blade.php qui est dans les layouts, on a un slot du nom de header <header></header> qu'on va utiliser comme suit --}}
    <x-slot name="header">
        Liste des Produits
    </x-slot>
    {{-- Apres le titre de la page, nous allons afficher les produits en bouclant sur un template si on l'a ou on l'écrit nous-même --}}
    <div class="py-12">
