                    ...
                    <tbody>
                        <template v-for="product in products" v-bind:key="product.id">
                            <tr>
                                ...
                                <td class="text-right">
                                    <!-- prix multiplié par la quantité -->
...
<!-- En fait, lors de l'ajout au panier, dans le repository on a specifié les informations qu'on envoie
     donc lors de l'affichage du panier, ce sont les memes champs qu'on recupère, les champs specifiés dans la fonction d'ajout au panier dans le repository -->